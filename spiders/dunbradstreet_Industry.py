...
class IndustryPage(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if response.status == 200:
            ...
            all_industrys = response.xpath(
                "//div[@class='accordion_list clearfix']").css("div.col-md-12")
            all_industry_names = np.array(
                all_industrys.css("div.title::text").extract())
            ...
            for i in range(len(specific_industry_names)):
                ...
                if not os.path.exists(FILE_PATH):
                    ...
                    print (f"Exists ... {FILE_PATH} ... {specific_industry_names[i]} ... Number of Category {idx+1}")
